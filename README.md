...
Open the low-ember-coffee folder in VS Code.
Install the Live Server extension (optional but recommended), then right-click index.html → Open with Live Server.
